...
| Repository checks        | `pnpm check`: 12 successful tasks and 89 friends tests. Guarded preview deployment: 11 native workerd checks and all 26 Chromium/WebKit cases passed. Provider responses in browser tests are explicit fixtures.                                                                                                   |
