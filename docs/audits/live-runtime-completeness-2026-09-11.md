...
| Discovery and curation                           | The original all-300 illustration claim was invalidated by subject mismatches. The September 11 correction has 242 distinct, explicitly assigned photographs and 58 text-only entries: 164 retained and 78 replaced. The register records every discovery; source metadata and imagery were reviewed individually. No geographic image fallback remains. See CURRENT_STATUS for release evidence. |
