...
| Native browser             | Passed                     | 6 Chromium/WebKit tests with real navigation/cookies/fetch/storage. Clock and visibility signals are controlled in the lifecycle test only. |
...
| Preview / production       | Pending deployment         | Preview resources provisioned; production requires protected main-branch approval.                                                          |
| Backup / restore           | Pending cloud round-trip   | Separate empty restore resources provisioned.                                                                                               |
| Ask Omakase                | In progress                | Bounded Workers AI probe succeeded; implementation and live journey pending.                                                                |
