...
| Preview / production       | Preview deployed           | Preview deployed at 981a5f2; production requires protected main-branch approval.                                                                                                  |
| Backup / restore           | Pending cloud round-trip   | Separate empty restore resources provisioned.                                                                                                                                     |
| Ask Omakase                | In progress                | 66 fast tests and fixture browser journey pass; real model/source preflight returned validated cards; live shared journey blocked by exhausted daily provider allowance.          |
